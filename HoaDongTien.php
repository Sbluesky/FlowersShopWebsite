			...
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="category.php">Gerberas</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-9">
					...
					<div class="latest_product_inner row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoadongtien/Auspicious.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Auspicious">
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoadongtien/Glorious Memories.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Glorious Memories">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
								<a href="#">
									<h4>Glorious Memories</h4>
								</a>
								<h5>$150.00</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoadongtien/GoodLuck.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Good Luck">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
						...
						<aside class="left_widgets cat_widgets">
							...
							<div class="widgets_inner">
								<ul class="list">
									...
									<li>
										<a href="#">Gerberas_Hoa đồng tiền</a>
