				...
				<div class="col-lg-9">
					...
					<div class="latest_product_inner row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoalan/Bright_Tomorrow.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Bright Tomorrow">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
								<a href="#">
									<h4>Bright Tomorrow</h4>
								</a>
								<h5>$150.00</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoalan/Lucky_Flower.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Lucky Flower">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoalan/Prosperity.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Prosperity">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoalan/SummerSong.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Summer Song">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoalan/VICTORY.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="VICTORY">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
