			...
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="category.php">Carnation</a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-9">
					...
					<div class="latest_product_inner row">
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoacamchuong/LightAtTheDoorstep.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Light At The Doorstep">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
								<a href="#">
									<h4>Light At The Doorstep</h4>
								</a>
								<h5>$150.00</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoacamchuong/LoveToBeLoved.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="Love To Be Loved">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
								<a href="#">
									<h4>Love To Be Loved</h4>
								</a>
								<h5>$150.00</h5>
							</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
									<img class="img-fluid" src="img/product/hoacamchuong/WhenTheSunRises.jpg" alt="">
									<div class="p_icon">
										
										<form action="additem.php" method="post">
										<input type="hidden" name="name-flw" value="When The Sun Rises">
										<input type="submit" class="add_cart" value="AddCart" name="submit">
										</form>
									</div>
								</div>
								<a href="#">
									<h4>When The Sun Rises</h4>
								</a>
								<h5>$150.00</h5>
							</div>
						</div>
						...
						<aside class="left_widgets cat_widgets">
							...
							<div class="widgets_inner">
								<ul class="list">
									...
									<li>
										<a href="#">Carnation_Hoa cẩm chướng</a>
