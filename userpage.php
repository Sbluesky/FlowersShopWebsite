			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<img class="img-fluid" src="img/login7.jpg" alt="" style="height: 600px; width: 555px;" >
						<div class="hover">
							<h4>Need more selections?</h4>
							<p>We have a lot of sweet things for your lover.</p>
							<a class="main_btn" href="index.php">Go to Shop!</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<?php
							...
							$query = "SELECT * FROM user_infor WHERE ID='$ID' ";
								...
								while($row = $result->fetch_assoc())
									{
										echo "<p> Your name: " . $row["name"]. "</p> <br/>";
						...
						?>
						<br/>
						<button class="btn submit_btn"  > <a href = 'logout.php'>LOG OUT </a> </button>
					</div>
				</div>
			</div>
		</div>
