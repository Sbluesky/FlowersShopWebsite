					...
					<table class="table">
						...
						<tbody>
										...
										foreach($product as $value) 
											{
												...
												echo "<div class='media-body'>". $value . "</div>";
												echo "</div></td>";
												echo "<td><h5>$150.00</h5></td>";
												echo "<td><h5>$150.00</h5></td>";
												echo "<td><center><input type='checkbox' name='choose[$i]' value='$value'></center></td>";
												echo "</tr>";
												$i++;
											}	    
							...
							<tr class="bottom_button">
								<td>
									<a class="gray_btn" href="index.php">Go to shop</a>
								</td>
								<td>
								...
								<td>
									<div class="cupon_text" style="margin-left: -140px;">
										<input type="submit" class="gray_btn" name="submit" value="Remove Items">
									</form>
									</div>
								</td>
							</tr>
