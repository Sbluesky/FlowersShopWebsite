...
<body>
						...
						<li style="margin-left: -220px;">
							...
							<?php
								...
								while($row = $result->fetch_assoc())
									{
										echo "<p> It's all for you, " . $row["name"]. "</p>";
									}
			...
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						...
						<a href="userpage.php">Admin's Page</a>
					</div>
				</div>
			</div>
		</div>
	...
	<!--================Login Box Area =================-->
	<section class="login_box_area p_120" style="background-color: #9966ff; height: 1200px;">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<center><div class="login_form_inner" style="height: 1000px; width: 1170px; background-color: #fff">
						<h3>Thien Lam's Users</h3>
						<?php
							...
							while($row = $result->fetch_assoc())
								{
									...
									if(isset($_COOKIE["ID"]))
									{
											if($ID != $_COOKIE["ID"]) //kiểm tra xem ID đang đăng nhập đó có phải ID của admin không
										{
											...
											echo "<p > ID: " . $row["UserID"]. " _ User: " . $row["username"]. "</p><br/>";
										}
									}
							...
							echo "<input class='btn submit_btn' type='submit' value='Delete User' name='submit' class='submit'><br/>";
							echo "</form>";
							
						?>
						<br/>
						<button class="btn submit_btn" style="width: 150px;"  > <a href = 'logout.php'>LOG OUT </a> </button>
					</div></center>
				</div>
			</div>
		</div>
